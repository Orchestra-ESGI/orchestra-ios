...
class ScreensLabelLocalizableUtils{
    ...
    let settingsShare = NSLocalizedString("settings.share", comment: "")
    let settingsAbout = NSLocalizedString("settings.about", comment: "")
    let settingsContact = NSLocalizedString("settings.contact", comment: "")
    let settingsLibraries = NSLocalizedString("settings.libraries", comment: "")
    let settingsPrivacy = NSLocalizedString("settings.privacy", comment: "")
    let settingsCgu = NSLocalizedString("settings.tou", comment: "")
